...
namespace Zero.Eventbus.RabbitMQ
{
    public class RabbitMqEventBus : IEventBus, IDisposable
    {
        ...
        private readonly string _scopeName = BrokerName;
        private readonly int _retryCount;

        private IModel _consumerChannel;
        private string _queueName;
        public event EventHandler<IntegrationEvent> Started;
        public event EventHandler<IntegrationEvent> Published;
        ...
        private async Task ProcessEvent(string eventName, string message)
        {
            ...
            {
                using (var scope = _autoFac.BeginLifetimeScope(_scopeName))
                {
